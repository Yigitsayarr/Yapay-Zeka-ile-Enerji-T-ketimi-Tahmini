...
#ifndef INC_YIGIT_INA226_H_
#define INC_YIGIT_INA226_H_
...
/* Exported constant ---------------------------------------------------------*/
//0. bit R/W belirtiyor. Write başlaması için "0" olmalı. Read için "1" olmalı. (7 bits) + bit R/W  1 0 0 0 0 0 0 + 0          // A0=GND A1=GND
//                                                                                                  7.6.5.4.3.2.1. (0.)
...
// ---------------- MASK - ALERT - LIMIT TANIMLAMALARI DEVREDIŞI
...
// ---------------- OVER - UNDER VE LIMIT TANIMLAMALARI DEVREDIŞI
...
} ayce_IN226; // of structure

/* Exported functions prototypes ---------------------------------------------*/


// ---------------- SENSOR BAŞLATMA FONKSİYONU
